...
void ggml_compute_mul_mat(
    ...
    ggml_vec_dot_t    const vec_dot               = ggml_internal_get_type_traits(type).vec_dot;
    enum ggml_type    const vec_dot_type          = ggml_internal_get_type_traits(type).vec_dot_type;
    ggml_from_float_t const from_float_to_vec_dot = ggml_internal_get_type_traits(type).from_float;
    int64_t           const vec_dot_num_rows      = ggml_internal_get_type_traits(type).vec_dot_num_rows;
